...
.data
	...
	array:  .word   26.6, 24.3, 4.2, -5.75, 12.2, 1.0, -4.7, 69.9, 10.1, 8.2
	
	use_comma:  .asciiz ", "
	str1:	.asciiz "The following is a list of 10 float values that will be soon sorted by the Quicksort algorithm."
